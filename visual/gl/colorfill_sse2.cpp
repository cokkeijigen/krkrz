...
struct sse2_const_alpha_fill_blend_d_functor {
	...
	inline __m128i operator()( __m128i md1 ) const {
		...
		__m128i ma1 = _mm_set_epi32(
			TVPOpacityOnOpacityTable[simd_extract_u32(maddr, 3)],
			TVPOpacityOnOpacityTable[simd_extract_u32(maddr, 2)],
			TVPOpacityOnOpacityTable[simd_extract_u32(maddr, 1)],
			TVPOpacityOnOpacityTable[simd_extract_u32(maddr, 0)]);
